...
public class TestNGCustomReportListener extends TestBase implements IReporter {
    ...
    private static final Logger L = Logger.getLogger(TestNGCustomReportListener.class);
	...
	protected PrintWriter createWriter(String outdir) throws IOException {
		...
		return new PrintWriter(new BufferedWriter(new FileWriter(new File(outdir, "custom-emailable-report.html"))));
	}
